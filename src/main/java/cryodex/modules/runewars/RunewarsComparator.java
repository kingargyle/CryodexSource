...
public class RunewarsComparator extends TournamentComparator<RunewarsPlayer> {
	...
	private final RunewarsTournament t;
	private final CompareOptions[] sortOrder;

	public RunewarsComparator(RunewarsTournament t, CompareOptions[] sortOrder) {
		this.t = t;
		this.sortOrder = sortOrder;
	}

	@Override
	public int compare(RunewarsPlayer o1, RunewarsPlayer o2) {
	...
	private int compareOption(RunewarsPlayer o1, RunewarsPlayer o2,
