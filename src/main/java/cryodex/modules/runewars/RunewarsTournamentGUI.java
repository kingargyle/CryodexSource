...
public class RunewarsTournamentGUI implements TournamentGUI {

	private RoundTabbedPane roundTabbedPane;
	private RunewarsRankingTable rankingTable;
	...
	public RunewarsTournamentGUI(RunewarsTournament tournament) {
	...
	public RunewarsRankingTable getRankingTable() {
		if (rankingTable == null) {
			rankingTable = new RunewarsRankingTable(tournament);
		}
		return rankingTable;
	}
